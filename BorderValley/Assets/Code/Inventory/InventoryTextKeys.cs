namespace BorderValley.Inventory
{
    ...
    {
        public const string BagFull = "inventory.ui.error.bag_full";
        public const string DuplicateInstance = "inventory.ui.error.duplicate_instance";
        ...
        public const string QuestCannotDismantle = "inventory.ui.error.quest_cannot_dismantle";
        public const string EquippedCannotReforge = "inventory.ui.error.equipped_cannot_reforge";
